...
const WEB_AUTH_KEY = "hamdast-ai-web-auth";
...
const AuthBottomSheet = () => {
  ...
  const [callbacks, setCallbacks] = useAtom(authCallbacksAtom);
  ...
  const handleSubmitPhone = async (e) => {
    ...
    if (!ok) return toastUserError(data?.message, "خطا در ارسال کد");
  ...
  const handleSubmitCode = async (e) => {
    ...
    if (!ok) return toastUserError(data?.message, "کد نامعتبر است");
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center mb-4">
                <div className="flex size-12 items-center justify-center rounded-md">
                  <img src="/logo.png" alt="Hamdast AI" className="size-12" />
                </div>
                <h1 className="text-xl font-bold">ورود به پلتفرم هوش مصنوعی همدست </h1>
                ...
                <div className="flex justify-center" dir="ltr">
                  <VerificationInput
                    ...
                    classNames={{
                      container: "gap-3",
                      character:
                        "rounded-md border !border-border !bg-background shadow !w-12 !h-14 text-xl !text-foreground",
                      characterInactive: "!bg-muted",
                      characterSelected: "border-ring ring-2 ring-ring/50 !text-foreground",
                    }}
                  />
                </div>
