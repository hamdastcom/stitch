...
const defaultNavItems = [
  { id: "chat", icon: <MessageSquare />, label: "چت", href: "/" },
  { id: "image", icon: <Image />, label: "تصویر", href: "/image" },
  { id: "video", icon: <Video />, label: "ویدیو", href: "/video" },
  { id: "characters", icon: <Bot />, label: "شخصیت‌ها", href: "/characters" },
];
...
export const LimelightNav = ({
  ...
  return (
    <nav
      className={cn(
        "relative inline-flex items-center h-16 w-full bg-card text-foreground border  shadow-lg md:max-w-app",
        className
      )}
    >
