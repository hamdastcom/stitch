...
import { modelSupportsWebSearch } from "@/lib/models";
...
export function AIInputWithSearch({
  ...
  const supportsWebSearch = gpt ? true : modelSupportsWebSearch(currentModel);
  ...
  }, [supportsWebSearch, webSearchEnabled, searchMode]);
  ...
  const handleSubmit = () => {
    if (value.trim() || selectedImages.length > 0 || selectedFiles.length > 0) {
      ...
      onSubmit?.(
        value,
        gpt ? true : webSearchEnabled && supportsWebSearch,
        selectedImages,
        selectedFiles,
        isImageGeneration
  ...
  return (
    ...
    >
      <div className="relative max-w-app w-full mx-auto bg-white dark:bg-background rounded-xl">
        {showUpgradeCard && (
          <div className="relative px-4 py-5 w-full space-y-2 flex justify-between items-center border rounded-xl mb-2 bg-card text-foreground shadow-xl pointer-events-auto">
            <div>
              <p className="text-sm">
                قابلیت{" "}
        ...
        {usageHint && location.pathname.includes("/chat") && (
          <div className="fixed inset-0 z-50 bg-black/50 transition-opacity duration-200 pointer-events-none">
            <div className="p-4 absolute space-y-2 bottom-16 left-10 z-50 w-80 border rounded-xl bg-card text-foreground shadow-xl pointer-events-auto">
        ...
        <div className="relative flex flex-col">
          ...
          <div className="h-12 rounded-b-xl bg-secondary">
            <div className="absolute right-3 bottom-3 flex items-center gap-2">
              ...
              {!gpt && (
                ...
                >
                  ...
                  <DropdownMenuContent
                    side="top"
                    align="center"
                    className="bg-popover text-popover-foreground rounded-lg shadow-lg border border-border"
                  >
                    <DropdownMenuRadioGroup
                    ...
                    >
                      ...
                      {window.location.hostname !== "app.hamdast.com" && (
                        <>
                          {/* <DropdownMenuRadioItem
                            value="deep"
                            className="cursor-pointer"
              ...
              {!gpt &&
                searchMode &&
                (searchMode !== "web" || supportsWebSearch) && (
                  <div
                    className={cn(
