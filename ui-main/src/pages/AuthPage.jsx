...
export default function AuthPage({ className, ...props }) {
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      if (!ok) return toastUserError(data?.message, "ورود با حساب گوگل با خطا مواجه شد");
    ...
    onError: () => {
      toast.error("ورود با حساب گوگل با خطا مواجه شد");
    },
  });
                ...
                <FieldGroup>
                  <div className="flex flex-col items-center gap-2 text-center">
                    ...
                    >
                      ...
                      <span className="sr-only">همدست هوش </span>
                    </a>

                    <h1 className="text-xl font-bold">
                      خوش آمدید به Hamdast AI{" "}
                    </h1>
                ...
                <Field>
                  ...
                  <div className="flex justify-center" dir="ltr">
                    <VerificationInput
                      ...
                      classNames={{
                        container: "gap-3",
                        character: "rounded-md border !border-border !bg-background shadow !w-12 !h-14 text-xl !text-foreground",
